                    ...
                    for m, m_name in zip(metrics, metrics_names):
                        for k, thr in enumerate(metric_thrs):
                            ...
                            estimators += [
                                ...
                                SAPLMA("decoder", parameters_path=None, metric=m, metric_name=m_name, aggregated=getattr(args, "multiref", False), hidden_layer=layer, device=getattr(args, "md_device", "cuda")),  
                            ]
